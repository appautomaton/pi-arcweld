...
| `gemini-web-search.ts` | Cache-stable isolated Google Search Grounding `google_search` tool for Gemini models | Symlink at `~/.pi/agent/extensions/gemini-web-search.ts` |
